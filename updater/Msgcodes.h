...
// HTTP ADDRES
//*********************************************************************
const CString HTTP_REMOTE_ADDRES_REALEASE_DOWNLOAD		=_T("http://update.easymule.com/easymuleupdate");
const CString HTTP_REMOTE_ADDRES_BEAT_DOWNLOAD			=_T("http://update.easymule.com/easymulebetaupdate");
const CString HTTP_LOCAL_ADDRES_DEBUG_DOWNLOAD			=_T("http://update.easymule.com/easymulebetaupdate");
