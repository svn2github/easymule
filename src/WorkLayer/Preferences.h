...
//	friend class CPPgSecurity;
	...
	static  CString GetConfigDirByDirMode( int nDirMode,bool bCreate=true );
	...
	static	bool	FilterLANIPs()						{return false;/*filterLANIPs;*/}
...
//	static	void	SetNotifierSendMail(bool nv)		{m_bNotifierSendMail = nv;}
	...
	static bool		GetMonitorOnAlt() { return m_bMonitorOnAlt; }
	static void		SetMonitorOnAlt(bool on) { m_bMonitorOnAlt = on; }
	// {End}   Added by Soar Chin (8/31/2007)
...
protected:
	...
	static	CString	m_astrDefaultDirs[15];	//Added by thilon on 2007.05.28
	static	bool	m_abDefaultDirsCreated[15];
