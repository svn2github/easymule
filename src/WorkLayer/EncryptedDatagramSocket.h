...
protected:
	int DecryptReceivedClient(BYTE* pbyBufIn, int nBufLen, BYTE** ppbyBufOut, uint32 dwIP) const;
	int EncryptSendClient(uchar** ppbyBuf, int nBufLen, const uchar* pachClientHash) const;
