...
public:
	...
	bool	GetNextRequestedBlockbySequence(CUpDownClient* sender, Requested_Block_Struct** newblocks, uint16* count);
...
public:
	void	OnGetFileSizeFromInetPeer( uint64 uiFileSize ); //< 从http/ftp peer获取到下载任务文件大小
...
public:
	...
	INetBlockRange_Struct*	GetBlockRange(CUpDownClient* pClient);		//< Client来获取INetBlockRange
...
public:
	void ConnectManage(CUpDownClient *pUpDownClient,uint32 uConnectIP,CClientReqSocket *pSocket);
