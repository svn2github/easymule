...
#define K							10
//MODIFIED by VC-fengwen 2007/08/10 <begin> : Enlarge K-Bucket's capacity
//#define KBASE						4
#define KBASE						7
//MODIFIED by VC-fengwen 2007/08/10 <end> : Enlarge K-Bucket's capacity
#define KK							5
#define ALPHA_QUERY					3
//MODIFIED by VC-fengwen on 2007/11/19 <begin> : 使存储在本地的结点数可以增大。
//#define LOG_BASE_EXPONENT			5
#define LOG_BASE_EXPONENT			7
//MODIFIED by VC-fengwen on 2007/11/19 <end> : 使存储在本地的结点数可以增大。
