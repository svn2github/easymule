...
#define VC_VERSION_BUILD 71205//Added by thilon on 2006.01.10

#define EASYMULE_MJR	1		//	<major>		major number (e.g. 0)
#define EASYMULE_MIN	0		//	<minor>		minor number (e.g. 30)
#define	EASYMULE_UPDATE 0		//	<update>	update number (e.g. 0='a'  1='b'  2='c'  3='d'  4='e'  5='f' ...)
